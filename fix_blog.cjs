...
const componentCode = export function IndianWeddingHairstylesArticle() {
  return (
      ...
      <div className=\"grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto\">
        ...
        <article className=\"col-span-1 lg:col-span-9 space-y-12 text-slate-600 text-base leading-relaxed\">
          ...
          <section className=\"space-y-4\">
            ...
            <p>Long hair offers the most flexibility — full South Indian braids, large gajra buns, and elaborate half-up styles all rely on length for their signature volume and drape.</p>
            ...
            <p>Short-haired brides aren’t limited to fewer options — they’re often better suited to sleeker, more tailored looks. A side-swept style pinned with a jewelled clip works perfectly.</p>
          ...
          <section className=\"space-y-4\">
            ...
            <p>South Indian bridal hairstyles are built around the braid — a long, thick plait wound with jasmine gajra and finished with temple-style gold jewellery.</p>
          ...
          <section className=\"space-y-4\">
            ...
            <ul className=\"space-y-4 mt-4 list-disc pl-5\">
              <li><strong>Oval:</strong> Almost anything works — buns, braids, half-up styles, and open waves.</li>
          ...
          <section className=\"space-y-4\">
            ...
            <div className=\"space-y-6 mt-6\">
              ...
              <div><h4 className=\"font-bold text-slate-800\">Should sangeet hair be different from wedding day hair?</h4><p className=\"text-sm mt-1\">Yes — sangeet typically calls for a more voluminous, movement-friendly style.</p></div>
