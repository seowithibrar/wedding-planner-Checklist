...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonicalUrl = `${SITE_URL}/${lang}/about-us`;
  const title = `${common.footer.aboutUs} | WeddingPlanningChecklists.org`;
...
export default async function MultilingualAboutUs({ params }: Props) {
  const { lang } = await params;
