...
export const metadata: Metadata = {
  title: 'About Us — Wedding Planning Checklists',
  description:
    'Learn about our mission to help brides and couples plan stress-free, beautiful weddings with free checklists, timeline tools, and expert guides.',
  alternates: {
    canonical: 'https://www.weddingplanningchecklists.org/about-us',
  },
};
  ...
  return (
    <>
      ...
      <main className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-lg prose-rose max-w-none text-slate-700 leading-relaxed">
          ...
          <p>
            ...
            couples. We believe that everyone deserves to have their dream wedding, regardless of their
            budget or timeline, and that starts with having the right organizational tools at your
            fingertips.
          </p>
          <p>
