...
export const metadata: Metadata = {
  title: 'Visual Sitemap & Directory | WeddingPlanningChecklists.org',
  description:
    'Explore the complete directory of wedding planning checklists, interactive budgeting and timeline tools, and expert wedding guides.',
  alternates: {
    canonical: 'https://www.weddingplanningchecklists.org/sitemap',
  },
};

const breadcrumbItems = [
  { name: 'Home', item: 'https://www.weddingplanningchecklists.org' },
  { name: 'Sitemap', item: 'https://www.weddingplanningchecklists.org/sitemap' },
];
      ...
      <main className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 bg-white rounded-2xl border border-[#F3E8EA] shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#EFF6FF] text-blue-600 flex items-center justify-center text-xl font-bold">🛠️</div>
            <div>
          ...
          <div className="p-5 bg-white rounded-2xl border border-[#F3E8EA] shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#FCECF0] text-[#B76E79] flex items-center justify-center text-xl font-bold">📋</div>
            <div>
          ...
          <div className="p-5 bg-white rounded-2xl border border-[#F3E8EA] shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#FEF3C7] text-amber-600 flex items-center justify-center text-xl font-bold">📖</div>
            <div>
          ...
          <div className="p-5 bg-white rounded-2xl border border-[#F3E8EA] shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-slate-100 text-slate-700 flex items-center justify-center text-xl font-bold">🌐</div>
            <div>
              ...
              <div key={category.title} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {category.checklists.map((chk: any) => (
                    <Link
                      key={chk.slug}
                      href={`/checklists/${chk.slug}`}
                      className="p-4 bg-white rounded-2xl border border-[#F3E8EA] hover:border-[#B76E79] shadow-sm hover:shadow-md transition-all group space-y-2"
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-lg">{chk.icon}</span>
                        <span className="text-[9px] font-bold text-[#B76E79] bg-[#FCECF0] px-2 py-0.5 rounded-full">
                          {chk.totalTasks} Tasks
                        </span>
                      </div>
                      <h4 className="font-bold text-xs sm:text-sm text-[#1A1A1A] group-hover:text-[#B76E79] transition-colors leading-snug">
                        {chk.title}
                      </h4>
                      <p className="text-[11px] text-slate-500 line-clamp-2">{chk.description}</p>
                    </Link>
                  ))}
                </div>
              </div>
        ...
        {/* Section 3: Blog Articles & Guides */}
        <section className="space-y-6 pt-8">
          <div className="flex items-center justify-between border-b border-[#F3E8EA] pb-3">
            <div className="flex items-center gap-3">
              <span className="text-2xl">📖</span>
              <div>
                <h2
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Guides, Timelines &amp; Inspiration
                </h2>
                <p className="text-xs text-slate-500">
                  In-depth pillar guides for wedding timelines, budgeting, beauty, attire, and decor
                </p>
              </div>
            </div>
            <span className="text-xs font-bold text-[#B76E79] bg-[#FCECF0] px-3 py-1 rounded-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {blogArticles.map((art) => (
              ...
              >
                <span className="text-[10px] font-bold text-[#B76E79] uppercase tracking-wider">
                  {art.cat}
                </span>
                <h3 className="font-bold text-sm text-[#1A1A1A] group-hover:text-[#B76E79] transition-colors leading-snug">
                  {art.title}
                </h3>
                <span className="text-xs font-bold text-[#B76E79] inline-flex items-center gap-1 group-hover:gap-2 transition-all pt-1">
                  Read Guide →
                </span>
              </Link>
            ))}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Core Website &amp; Legal Pages
                </h2>
                <p className="text-xs text-slate-500">
                  Essential site navigation, company mission, contact channels, and policies
                </p>
              </div>
            </div>
          </div>
